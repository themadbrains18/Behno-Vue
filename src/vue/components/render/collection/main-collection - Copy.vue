<template>
    <section class="collection-sec">
        <div class="home" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy" infinite-scroll-distance="limit">
                    ...
                    <div class="sort_by">
                        <div class="sort_by_inner">
                            <div class="range">
                                ...
                                <input id="ageInputId" type="range" :value="setScreenRangeGrid" min="2" max="6" step="2"
            ...
            <div class="product_grid">
                <div class="grid_inner" v-bind:class="{ grid_inner_max: gridMax, grid_inner_min: gridMin }">
                    <div class="centeralign addmargin" v-for="product in customerlist[limit]" :key="product.id">
                        <div class="card" v-on:click="setSelectedCustomer(product.title)">
                            <img :src="product.images[0].src"
                                v-on:mouseover="mouseover($event, product.images[product.images.length - 1].src)"
                ...
                <div class="row centeralign addmargin"
                    v-bind:class="{ productnotfound: customerlist.length == 0, productfound: customerlist.length > 0 }">
                    <h2>We're sorry, no matches were found.</h2>
                    <h4>We couldn't find any results for your selected filters. Clear your filters, or contact
                        our team
                        and
            ...
            <!-- <div class="row centeralign" style="margin:auto">
                    <div class="col-md-12">
                        <ul class="flex pt-6">
                            <li :key="index" :class="{ 'pageactive': index === page_index }"
                                v-for="(page, index) in customerlist">
...
export default {
    ...
    methods: {
        ...
        onClick: function (event) {
            // console.log('sfsdf',event);sortFilter
        ...
        loadMore() {
            ...
            const append = products.slice(
                ...
                this.customerlist.length + this.limit
            );
            this.customerlist = this.customerlist.concat(append);
