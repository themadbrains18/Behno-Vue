  ...
  <section class="collection-sec">
    ...
    >
        ...
        <div class="responsiveFilter">
          ...
          <div class="filderDropdown">
            ...
            <div class="dropdown_head">
              <button class="filter_cta filter">
                FILTER
              </button>
              <button class="filter_cta clear-filter">
                CLEAR FILTERS
                <svg
                  data-v-35171425=""
                  width="10"
      ...
      <div class="product_grid">
        ...
        >
          <div
            v-for="product in customerlist[limit]"
            :key="product.id"
            class="centeralign addmargin"
          >
            <div
              class="card"
              @click="setSelectedCustomer(product.title)"
            >
              <img
                :src="product.images[0].src"
                @mouseover="mouseover($event, product.images[product.images.length - 1].src)"
        ...
        <div
          ...
          :class="{ productnotfound: customerlist.length == 0, productfound: customerlist.length > 0 }"
        >
