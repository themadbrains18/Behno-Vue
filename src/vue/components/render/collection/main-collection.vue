    ...
    <section class="collection-sec">
        <div class="home">
            <div class="filter_row">
                ...
                <div class="row_inner">
                    <div class="filters">
                        <div class="filter" @mouseenter="show = true" @mouseleave="show = false">
                        ...
                        <div class="filter" @mouseenter="showColor = true" @mouseleave="showColor = false">
                            <div class="dropdown" >
                                <div class="overselect">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="filter" @mouseenter="showSize = true" @mouseleave="showSize = false">
                            <div class="dropdown" >
                                <div class="overselect">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="filter filter-modifier" @mouseenter="showMaterial = true" @mouseleave="showMaterial = false">
                            <div class="dropdown" >
                                <div class="overselect">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="filter">
                            <button class="clearFilter" v-bind:class="{ activeClear: showClearAll }"
                                @click="clearAllFilter()">Clear filters
            ...
            <div class="product_grid">
                ...
                <div class="row centeralign addmargin"
                    v-bind:class="{ productnotfound: productList.length == 0, productfound: productList.length > 0 }">
                    ...
                    <div class="col-md-12">
                        <ul class="flex pt-6">
                            <li :key="index" :class="{ 'pageactive': index === page_index }"
                                v-for="(page, index) in productList">
