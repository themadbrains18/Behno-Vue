            ...
            <div class="sec_head">
                <div class="pre_arrow_wrapper">
                    <button class="prev_cta">
                        <img src="https://cdn.shopify.com/s/files/1/0577/1178/8125/files/left-arrow-new.svg?v=1654580925" alt="error">
                    </button>
                </div>
            </div>
            ...
            <div class="sec_content">
                <div class="sec_left">
                    ...
                    <div class="product_grid">
                        {{ shopifyData.cartItems }}
                        <div class="card" v-for="(value, key) in shopifyData.cartItems" :key="key">
                            <!-- <a href="#"> -->
                                <div class="product_img_wrapper" :id="product_img_wrapper(value.id)" >
                                ...
                                <h5 class="card-title bold" >${{ value.price }}</h5>
                            <!-- </a> -->
                        </div>
