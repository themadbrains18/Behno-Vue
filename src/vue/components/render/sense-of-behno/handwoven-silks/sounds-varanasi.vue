<template>
  ...
  <section class="sec_sounds_varanasi">
      ...
      <div class="sec_video">
          <video  controls autoplay="true" loop="true" muted="true"  controlsList="nodownload" webkit-playsinline="true" playsinline="true" preload="none" v-for="(item, index) in shopifyData.videoData" :key="index">
...
.card_heading_b.sec_inner_heading {
  margin: 14px 0;
  text-align: start;
}
.subtitle{
