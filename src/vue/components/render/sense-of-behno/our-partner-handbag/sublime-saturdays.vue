<template>
    <section class="sublime_saturdays_sec">
...
.fig_cption_inner.first{
    max-width: 374px;
    margin-top: 89px;
}
.fig_cption_inner.second{
    max-width: 310px;
    margin-top: 171px;
}
.img_item_3{
...
.img_item_2 + .fig_caption {
    padding-left: 22px;
}
.img_item_3 + .fig_caption {
    padding-left: 12px;
}
.image_collarge{
    padding: 0 20px;
